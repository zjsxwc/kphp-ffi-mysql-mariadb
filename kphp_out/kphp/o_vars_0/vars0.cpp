...
void const_vars_init_priority_0_file_0() noexcept {
  ...
  v$const_string$usf8e5e1651bd01df3.assign_raw (&raw[288]);
  v$const_string$usfa3590f20c4d7282.assign_raw (&raw[304]);
  v$const_string$usff5c5a0e3e83b8f0.assign_raw (&raw[328]);
